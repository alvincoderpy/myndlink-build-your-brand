        ...
        <Card className="p-8 shadow-glow">
          <div className="mb-6 text-center">
            ...
            <p className="text-sm text-muted-foreground">
              {isLogin ? "Bem-vindo de volta! Entra para continuar." : "Começa a criar a tua loja online agora."}
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <Input id="email" type="email" placeholder="teu@email.com" value={email} onChange={e => setEmail(e.target.value)} required className="mt-1" />
            </div>

            <div>
              <Label htmlFor="password">Password</Label>
              <Input id="password" type="password" placeholder="••••••••" value={password} onChange={e => setPassword(e.target.value)} required className="mt-1" minLength={6} />
            </div>
