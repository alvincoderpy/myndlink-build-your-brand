          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            {!isLogin && <>
                <div>
                  ...
                  <Input id="firstName" type="text" placeholder={t('auth.firstName')} value={firstName} onChange={e => setFirstName(e.target.value)} required />
                </div>
                <div>
                  <Label htmlFor="lastName">{t('auth.lastName')}</Label>
                  <Input id="lastName" type="text" placeholder={t('auth.lastName')} value={lastName} onChange={e => setLastName(e.target.value)} required />
                </div>
              </>}
